...
DECLARE_LOG_CATEGORY_EXTERN(LogGKRepGraph, Display, All);

/** GK Replication Graph implementation. See additional notes in GKReplicationGraph.cpp! */
...
private:
	...
	/** Classes that had their replication settings explictly set by code in UGKReplicationGraph::InitGlobalActorClassSettings */
	TArray<UClass*> ExplicitlySetClasses;
};

UCLASS()
class UGKReplicationGraphNode_AlwaysRelevant_ForConnection : public UReplicationGraphNode_AlwaysRelevant_ForConnection
{
	GENERATED_BODY()
...
*/
UCLASS()
class UGKReplicationGraphNode_PlayerStateFrequencyLimiter : public UReplicationGraphNode
{
	GENERATED_BODY()
